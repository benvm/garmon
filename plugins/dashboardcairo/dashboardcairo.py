...
class DashBoard (gtk.VBox, Plugin):
    ...
    def __init__(self, app) :
        ...
        app.prefs.register('dashboard.needle', '#F20D1B')
        app.prefs.register('dashboard.background', '#2F2323')
        app.prefs.register('dashboard.backplate', '#FFFFFF')
        app.prefs.register('dashboard.rim', '#CBCBCB')
        ...
        self._needle_color = app.prefs.get('dashboard.needle')
        self._background = app.prefs.get('dashboard.background')
        self._backplate = app.prefs.get('dashboard.backplate')
        self._rim_color = app.prefs.get('dashboard.rim')
        
        cb_id = app.prefs.add_watch('dashboard.needle', 
                                                self._prefs_notify_color_cb)
        self._pref_cbs.append(('dashboard.needle', cb_id))
        cb_id = app.prefs.add_watch('dashboard.background', 
                                                self._prefs_notify_color_cb)
        self._pref_cbs.append(('dashboard.background', cb_id))
        cb_id = app.prefs.add_watch('dashboard.backplate', 
                                                self._prefs_notify_color_cb)
        self._pref_cbs.append(('dashboard.backplate', cb_id))
        cb_id = app.prefs.add_watch('dashboard.rim', 
                                                self._prefs_notify_color_cb)
        self._pref_cbs.append(('dashboard.rim', cb_id))
